...
echo -e "注意：！！！请将该脚本置于项目跟目录"
echo -e "这是一个初始化 Spring Boot 项目脚本，可以生成目录及目录下固定的java文件：\\n /controller/dao/dto/entity/service/serviceImpl/主类/\n"

mkdir -pv ./src/main/{java/com/lambert/fun/{config,controller,dao,dto,entity,service/serviceImpl,config,exception,result,utils},resources}
...
do
name=`echo -e "$file" | awk '{print $1}' FS="Entity."`

serviceName=`echo -e "$file" | awk '{print $1"Service"}' FS="Entity."`
serviceNameClass=`echo -e "$file" | awk '{print $1"Service."$2}' FS="Entity."`
echo -e "package com.lambert.fun.service;\n\npublic interface $serviceName {\n\n}\n"> ./src/main/java/com/lambert/fun/service/$serviceNameClass

serviceImplName=`echo -e "$file" | awk '{print $1"ServiceImpl"}' FS="Entity."`
serviceImplNameClass=`echo -e "$file" | awk '{print $1"ServiceImpl."$2}' FS="Entity."`
...
controllerName=`echo -e "$file" | awk '{print $1"Controller"}' FS="Entity."`
controllerNameClass=`echo -e "$file" | awk '{print $1"Controller."$2}' FS="Entity."`
...
daoName=`echo -e "$file" | awk '{print $1"DAO"}' FS="Entity."`
daoEntityName=`echo -e "$file" | awk '{print $1}' FS="."`
daoNameClass=`echo -e "$file" | awk '{print $1"DAO."$2}' FS="Entity."`
...
dtoName=`echo -e "$file" | awk '{print $1"ReqDTO"}' FS="Entity."`
dtoNameClass=`echo -e "$file" | awk '{print $1"ReqDTO."$2}' FS="Entity."`
