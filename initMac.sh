...
echo "这是一个初始化 Spring Boot 项目脚本，可以生成目录及目录下固定的java文件：\\n /controller/dao/dto/entity/service/serviceImpl/主类/\n"
...
if [[ ! $allEntity ]];then
	echo "entity 为空无法自动生成以上java类，自动跳出循环\n"
